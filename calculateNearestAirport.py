...
def getAllStates():
    ...
    #print(len(df_airports_filter['iso_state'].unique()))
...
def calculateNearestAirport(state):
    ...
    try:
        ...
        for zc in zipcodes:
            ...
            #print(state,"- Done calculating for",zc['zipcode'])

        #writeNearestAirportbyStateCSV(dicts)
        with open("Output/"+state+"_nearest_airport.csv","w") as csv_file:
